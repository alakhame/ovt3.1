 ...
 */
class Worker extends \OVT\GeneralBundle\Entity\Worker implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OVT\\GeneralBundle\\Entity\\Worker' . "\0" . 'id', '' . "\0" . 'OVT\\GeneralBundle\\Entity\\Worker' . "\0" . 'language', '' . "\0" . 'OVT\\GeneralBundle\\Entity\\Worker' . "\0" . 'groupe', '' . "\0" . 'OVT\\GeneralBundle\\Entity\\Worker' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Worker $proxy) {
