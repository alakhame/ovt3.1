...
namespace Proxies\__CG__\OVT\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \OVT\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'organisation', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'type', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'state', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'phoneNumber', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'notification', '' . "\0" . 'OVT\\UserBundle\\Entity\\User' . "\0" . 'session', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
     ...
     * {@inheritDoc}
     */
    public function addNotification(\OVT\GeneralBundle\Entity\Notification $notification)
    {
     ...
     * {@inheritDoc}
     */
    public function removeNotification(\OVT\GeneralBundle\Entity\Notification $notification)
    {
     ...
     * {@inheritDoc}
     */
    public function addSession(\OVT\GeneralBundle\Entity\Session $session)
    {
     ...
     * {@inheritDoc}
     */
    public function removeSession(\OVT\GeneralBundle\Entity\Session $session)
    {
